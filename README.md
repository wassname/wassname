...
- **[Moral Maps](https://github.com/wassname/moral-maps): where do models sit among humans?**
  ...
  Where do models fall in terms of human culture, personality, and humour? I apply human surveys to LLMs and compare them with maps of human answers. On the World Values Survey I scored 17 frontier models by rated sampling, twelve ratings per item with the option order shuffled, and placed them among 90 human societies on the Inglehart-Welzel axes. They spread from 0.53 to 0.76 on the secular-rational axis, with gpt-5.5 furthest out at 0.76 ± 0.07, and 8 of the 17 land above Sweden, the most secular of the 90 societies. On self-expression none of them pass Iceland, so the models are stretched much further in the secular direction than they are west of Silicon Valley. Whether the newer ones keep voyaging is less clear: most families drift outward with each release, but the moves sit inside the 95% intervals I report for every model.
