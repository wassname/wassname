...
| Repo | What it does |
|------|--------------|
| [ssteer-eval-aware](https://github.com/wassname/ssteer-eval-aware) | S-space steering suppresses eval-awareness in Qwen3-32B; gap +7pp to +1pp vs prior +26pp. Apart Research hackathon. |
